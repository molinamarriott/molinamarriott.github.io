...
>
  {/* Nombre personal añadido arriba del título principal */}
  <h2 className="text-2xl md:text-3xl font-semibold mb-2 text-muted-foreground">
    Alejandro Molina Marriott
  </h2>
